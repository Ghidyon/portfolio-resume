            ...
            <div class="my_box">
              <div class="left">
                ...
                <div class="tokyo_progress">
                  <div class="progress_inner" data-value="100">
                    <span
                      ><span class="label">Leadership Skills</span
                  ...
                  <div class="progress_inner" data-value="100">
                    <span
                      ><span class="label">Agile Product Management</span
                      ><span class="number"></span></span
                    >
                    <div class="background">
                      <div class="bar"><div class="bar_in"></div></div>
                  ...
                  <div class="progress_inner" data-value="100">
                    <span
                      ><span class="label">Product Management - User & Market Research</span
                      ><span class="number"></span></span
                    >
                    <div class="background">
                      <div class="bar"><div class="bar_in"></div></div>
              ...
              <div class="right">
                ...
                <div class="tokyo_progress">
                  <div class="progress_inner" data-value="100">
                    <span
                      ><span class="label">Business Development</span
                      ><span class="number"></span></span
                    >
                    <div class="background">
                      <div class="bar"><div class="bar_in"></div></div>
                  ...
                  <div class="progress_inner" data-value="100">
                    <span
                      ><span class="label">Product Analytics - Firebase, Mixpanel, Posthog</span>
                      <span class="number"></span></span
                    >
                    <div class="background">
                      <div class="bar"><div class="bar_in"></div></div>
                  ...
                  <div class="progress_inner" data-value="100">
                    <span
                      ><span class="label">Wireframing and Design - Figma, Miro.</span
                      ><span class="number"></span></span
                    >
                    <div class="background">
                      <div class="bar"><div class="bar_in"></div></div>
        ...
        <div class="menu_inner">
          ...
          <div class="menu">
            <ul>
              <li>
                <a href="#home"
                  ><img class="svg" src="img/svg/home-run.svg" alt=""
                /></a>
              </li>
              <li>
                <a href="#about"
                  ><img class="svg" src="img/svg/avatar.svg" alt=""
                /></a>
              </li>
              <li>
                <a href="#portfolio"
                      ...
                      <ul>
                        ...
                        <li>
                          <p>
                            <span>Email:</span
                            ><a
                              href="mailto:irenesquared@gmail.com"
                        ...
                        <li>
                          <p>
                            <span>Phone:</span
                            ><a href="tel:+2348160783664"><span>[phone number&#160;protected]</span
                              ></a>
                          </p>
                        </li>
                        <li>
                  ...
                  <ul class="portfolio_list gallery_zoom">
                    <li class="vimeo">
                      <div class="inner">
                        <div
                          ...
                          data-title="Mood Diary"
                          data-category="Mental Health"
                        >
                          <a
                            href="https://drohealth.com/" target="_blank"
                          >
                            <img src="img/thumbs/1-1.jpg" alt="mood diary" />
                            <div
                              class="main_image"
                              data-img-url="img/portfolio/MoodDiary1.jpeg"
                            ></div>
                          </a>
                        </div>
                      </div>
                    ...
                    <li class="youtube">
                      <div class="inner">
                        <div
                          class="entry tokyo_tm_portfolio_animation_wrap"
                          data-title="Period Diary"
                          data-category="Women's Health"
                        >
                          <a
                          href="https://drohealth.com/" target="_blank"
                          >
                            ...
                            <div
                              class="main_image"
                              data-img-url="img/portfolio/PeriodDiary1.jpeg"
                            ></div>
                          </a>
                        </div>
                      </div>
                              ...
                              <li>
                                <div class="list_inner">
                                  <div class="my_image">
                                    ...
                                    <div
                                      class="main"
                                      data-img-url="img/portfolio/MoodDiary2.jpeg"
                                    ></div>
                                  </div>
                                </div>
                              </li>
                              ...
                              <li>
                                <div class="list_inner">
                                  <div class="my_image">
                                    ...
                                    <div
                                      class="main"
                                      data-img-url="img/portfolio/PeiodDiary2.jpeg"
                                    ></div>
                                  </div>
                                </div>
                              </li>
